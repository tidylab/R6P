...
```{r Repository-Persistent-implementation, echo=TRUE, results='markup'}
...
```{r Repository-Persistent-implementation-addon, echo=TRUE, results='markup'}
...
## `Appendix A - collections::dict`{#appendix-dict}
