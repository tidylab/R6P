...
#'
#' @details
#' This is an abstract base class. Instantiating `Singleton` directly triggers an error.
#' Classes inheriting from `Singleton` share a single instance.
#'
#' @examples
  ...
  public = list(
    ...
    initialize = function() {
      ...
      if (classname == "Singleton") {
        stop(paste(classname, "is an abstract base class and cannot be instantiated directly"))
      }
